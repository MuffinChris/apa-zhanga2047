...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  private void setUpNextAndPreviousButtons()
  {
    ...
    Icon prevIcon = new ImageIcon(DigitalPicture.class.getResource("images/leftArrow.png"), 
                                  "previous index");
    Icon nextIcon = new ImageIcon(DigitalPicture.class.getResource("images/rightArrow.png"), 
                                  "next index");
